...
<a href = "/files/Annex%20A_Muslims_8Jun20.pdf" target = "_blank">Annex A</a> (for Muslims) and <a href = "/files/Annex%B_Non-Muslims_Jun20.pdf" target = "_blank">Annex B</a> (for non-Muslims) set out the list of documents we need. 

For a reimbursement of funeral expenses, <a href = "/files/Annex%C_Funeral_8Jun20.pdf" target = "_blank">Annex C</a> sets out the list of documents we need.
